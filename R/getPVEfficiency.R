...
#'   \item \code{effCondStand_eta} \eqn{\gamma_{std}} in \eqn{\%}
#'   \item \code{coeffPotenza_gamma} \eqn{\gamma} in \eqn{\%}
#' }
...
#'   \item \code{angoloPannelli} the tilt angle of PV cells (\eqn{0^\circ} horizontal)
#' }
#' 
